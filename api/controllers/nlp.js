...
const NLP_PATH 	= `${__dirname}/`;
console.log(NLP_PATH);
...
module.exports = {
	...
	user(req, res) {
		...
		if(!email || !googleId)
			return res.status(404).send('Paylod missing email or googleId, please try agian.');
	...
	web(req, res) {
		...
		// natlan.entities(webpage, (err, data) => );
